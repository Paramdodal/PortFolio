...
const sections = document.querySelectorAll('section[id]'); // Already exists
...
// Scroll Reveal for Certificates Section
sr.reveal('.certificates-container', {delay: 200});
sr.reveal('.certificate', {interval: 200});
